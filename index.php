            ...
            <div class="row pt-5">
                <div class="col-md-8 col-xl-6 text-center text-md-start mx-auto">
                    <div class="text-center">
                        <p class="fw-bold text-success mb-2">best #1 to do softwares</p>
                        <h1 class="fw-bold">The best solution for you to don't forget your works</h1>
                    </div>
                </div>
                <div class="col-12 col-lg-10 mx-auto">
                    <div class="position-relative" style="display: flex;flex-wrap: wrap;justify-content: flex-end;">
                        <div style="position: relative;flex: 0 0 45%;transform: translate3d(-15%, 35%, 0);"><img class="img-fluid" data-bss-parallax="" data-bss-parallax-speed="0.8" src="assets/img/paper2.png"></div>
                        <div style="position: relative;flex: 0 0 45%;transform: translate3d(-5%, 20%, 0);"><img class="img-fluid" data-bss-parallax="" data-bss-parallax-speed="0.4" src="assets/img/paper1.png"></div>
                        <div style="position: relative;flex: 0 0 60%;transform: translate3d(0, 0%, 0);"><img class="img-fluid" data-bss-parallax="" data-bss-parallax-speed="0.25" src="assets/img/paper3.png"></div>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col mb-5">
                        <div class="card shadow-sm">
                            <div class="card-body px-4 py-5 px-md-5">
                                ...
                                <h5 class="fw-bold card-title">Notification you to do works&nbsp;</h5>
                                <p class="text-muted card-text mb-4">If you forget your daily works, we send a notification to remember :)</p>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
                        <div class="card shadow-sm">
                            <div class="card-body px-4 py-5 px-md-5">
                                ...
                                <h5 class="fw-bold card-title">Share a summery</h5>
                                <p class="text-muted card-text mb-4">Share your works that you want to do with other Applications !</p>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-4">
                        <div class="card shadow-sm">
                            <div class="card-body px-4 py-5 px-md-5">
                                ...
                                <h5 class="fw-bold card-title">Pin necessary works</h5>
                                <p class="text-muted card-text mb-4">If you have a work that is very necessary for you, you can pin it on top of all !</p>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-4">
                        <div class="card shadow-sm">
                            <div class="card-body px-4 py-5 px-md-5">
                                ...
                                <h5 class="fw-bold card-title">Comment for works</h5>
                                <p class="text-muted card-text mb-4">If you forget why you should do this work? you can add comment for your daily work</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12 mb-4">
                        <div class="card bg-primary-light">
                            <div class="card-body text-center px-4 py-5 px-md-5">
                                <p class="fw-bold text-primary card-text mb-2">START NOW</p>
                                <h5 class="fw-bold card-title mb-3">Let's Start We Services !!</h5><a href="addwork.php"><button class="btn btn-primary btn-sm" type="button">Start Now</button></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="d-flex flex-wrap flex-md-column justify-content-md-start align-items-md-start h-100">
                        <div class="d-flex align-items-center p-3">
                            ...
                            <div class="px-2">
                                ...
                                <p class="text-muted mb-0">+989373615353</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center p-3">
                            ...
                            <div class="px-2">
                                ...
                                <p class="text-muted mb-0">matinkahi95@gmail.com</p>
                            </div>
                        </div>
                    </div>
                </div>
